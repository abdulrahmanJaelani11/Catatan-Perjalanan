...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark " id="accordionSidebar" style="display: none; z-index: 99; background: rgb(2,0,36); background: linear-gradient(163deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 41%, rgba(0,212,255,1) 86%);">
                ...
                <a class="nav-link" href="<?= base_url('Profil'); ?>">
                    <div class="row justify-content-center">
                        <div class="col text-center">
                            <img src="<?= base_url('assets'); ?>/img/pp/<?= session('img'); ?>" class="img-fluid rounded-circle" width="60">
                        </div>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('IsiCatatan'); ?>">
                    <i class="fas fa-fw fa-pen"></i>
                    <span>Isi Catatan</span></a>
            </li>
                        ...
                        <div class="col">
                            <div class="card shadow my-2">
                                <div class="card-body text-center">
                                    <h4 class="h3 font-weight-bold text-dark">Selamat Datang</h4>
                                    <p class="sambut">Anda Login Sebagai <?= session('nama'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
